...
?><br><br><br>
        <center><table class="table table-striped" style=border-color:#38b6ff;margin-top:5%;width:80%>
            <thead>
                ...
                <th scope="col" style=width:15%><h4>Gender</h4></th>
                <th scope="col" style=width:25%><h4>Phone</h4></th>
                <th scope="col" style=width:30%><h4>Email</h4></th>
                <th scope="col" style=width:10%><h4>Action</h4></th>
                </tr>
            </thead>
            <tbody>
            <?php
                $query = "SELECT * FROM data_user WHERE Role = 'STAFF' OR Role = 'ADMIN'";
                $result = mysqli_query($connect,$query);
